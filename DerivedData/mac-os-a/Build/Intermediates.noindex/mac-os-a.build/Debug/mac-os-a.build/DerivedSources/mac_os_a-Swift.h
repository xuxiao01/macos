...
SWIFT_MODULE_NAMESPACE_PUSH("mac_os_a")

SWIFT_CLASS("_TtC8mac_os_a11AppDelegate")
@interface AppDelegate : NSObject <MSCrashesDelegate, MSPushDelegate, NSApplicationDelegate>
...
SWIFT_CLASS("_TtC8mac_os_a9GameScene")
...
SWIFT_CLASS("_TtC8mac_os_a14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, weak) IBOutlet NSTextField * _Null_unspecified helloLabel;
